			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label> Student Name :</font></label> <input
						...
						&emsp; <label>RollNo :</label> <%=HTMLUtility.getList("rollNo123", String.valueOf(bean.getId()), l)%>

						<label>College List:</label> <%=HTMLUtility.getList("collegeid", String.valueOf(bean.getId()), clist)%>
