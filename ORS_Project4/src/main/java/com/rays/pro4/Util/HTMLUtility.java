...
;
 ...
 public static String getList(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 213px;  height: 23px;' class='form-control' name='" + name + "'>");
 ...
 public static String getList1(String name, String selectedVal, List list) {
     ...
     Collections.sort(list);       
     StringBuffer sb = new StringBuffer("<select style='width: 150px;  height: 23px;' class='form-control' name='" + name + "'>");
