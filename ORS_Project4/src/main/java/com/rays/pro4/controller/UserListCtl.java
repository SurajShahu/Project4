...
public class UserListCtl extends BaseCtl{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("In doGet bydefault doGet runs");
		...
		try {
			...
			System.out.println("model.search returns list=" + list);
			...
			System.out.println("ServletUtility.setList ,setPageNo ,setPageSize ,forward on view");
		} catch (ApplicationException e) {
			log.error(e);
